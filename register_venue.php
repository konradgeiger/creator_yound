<?php
    ...
    if(isset($_POST['SUBMIT']))
    {
      ...
      $_SESSION['NAME_VENUE'] = $name;
      $_SESSION['LOCATION_VENUE'] = $location;
      $_SESSION['TYPE_VENUE'] = $type;
      $_SESSION['MUSIC_VENUE'] = $size;
      $_SESSION['PRICE_VENUE'] = $price;
      $_SESSION['WEBSITE_VENUE'] = $website;
      $_SESSION['BIO_VENUE'] = $bio;

      $_SESSION['SOURCE'] = "venue";
...
<html lang="en">
    ...
    <body>
      ...
      <section>
          <center><h3>Register your venue</h3></center>
          <div class="container">
                      <div class="row">
                        <form id="form-buchung" action="register_venue.php" method="post">
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                  ...
                                  <input type="text" name="SIZE" id="size" placeholder="Size(max. amount of people)">
