<?php
  ...
  $request = "SELECT id FROM caterer";
  ...
  {
    $caterer = $_POST['SUBMIT'];
    $_SESSION['CATERER_SESSION'] = $caterer;

    header("Location: http://creator.yound.de/checkout.php");
  }
?>
<!doctype html>
<html lang="en">
    ...
    <section>
      <center><h3>4. Which food do you want?</h3></center>

      <form id="form-venue" action="caterer.php" method="post">

        <?php

          for($b=1;$b < $amount+1;$b++)
					{
            $result2 = "SELECT * FROM caterer WHERE id = '$b'";
                   ...
                   <div class=\"panel-body\">
                     <div class=\"row\">
                       ...
                       <div class=\"col-xs-12 col-md-9\">
                         ...
                         <b>Price(per Person):</b> $price[$b]<br>
                         <b>Capacity:</b> $capacity[$b]<br>
                         <b>Food:</b> $food[$b]<br>
         ...
         <button type="submit" name="SUBMIT" value="No Caterer">Skip</button>
         </div>
      </form>
