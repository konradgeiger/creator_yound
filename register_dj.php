<?php
    ...
    if(isset($_POST['SUBMIT']))
    {
      ...
      $_SESSION['NAME_DJ'] = $name;
      $_SESSION['LOCATION_DJ'] = $location;
      $_SESSION['TYPE_DJ'] = $type;
      $_SESSION['MUSIC_DJ'] = $music;
      $_SESSION['PRICE_DJ'] = $price;
      $_SESSION['BIO_DJ'] = $bio;
      $_SESSION['WEBSITE_DJ'] = $website;
      $_SESSION['REFERENCE__DJ'] = $reference;
...
<html lang="en">
    ...
    <body>
      ...
      <section>
          <center><h3>Register as a DJ/Band</h3></center>
          <div class="container">
                      <div class="row">
                        <form id="form-buchung" action="register_dj.php" method="post">
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                  ...
                                  <input type="text" name="TYPE" id="type" placeholder="Type(DJ,Band,...)">

                                  <input type="text" name="MUSIC" id="music" placeholder="Music">

                                  <input type="text" name="PRICE" id="price" placeholder="Price(per night)">

                                  <input type="text" name="BIO" id="bio" placeholder="Description">

                                  <input type="text" name="WEBSITE" id="website" placeholder="Website">

                                  <input type="text" name="REFERENCE" id="reference" placeholder="Set/Video Reference">
                                </div>
                                <div class="col-md-6 col-md-offset-3">
