<?php
  ...
  {
    $dj = $_POST['SUBMIT'];
    $_SESSION['DJ_SESSION'] = $dj;

    header("Location: http://creator.yound.de/tech.php");
  }
?>
<!doctype html>
<html lang="en">
    ...
    <section>
      <center><h3>2. What music do you want to hear?</h3></center>

      <form id="form-venue" action="dj.php" method="post">

        <?php

          for($b=1;$b < $amount+1;$b++)
					{
            $result2 = "SELECT * FROM dj WHERE id = '$b'";
         ...
         <button type="submit" name="SUBMIT" value="No DJ">Skip</button>
         </div>
      </form>
